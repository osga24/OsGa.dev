      ...
      <div className="flex justify-center items-center min-h-[calc(100vh-4rem)] md:h-screen px-6 pt-0 md:pt-0">
        <div className="flex flex-col-reverse md:flex-row justify-between items-center w-full max-w-6xl mt-[-2rem] md:mt-0">
          <div className="flex flex-col justify-center items-center md:items-start md:pl-12">
            ...
            >
              A student from <span className="text-teal-600 font-bold">NYUST</span>, <a href="https://yunhack.com" className="text-blue-300">YunHack</a> Leader,
              <br /> passionate about cybersecurity and development,
              <br /> currently a CTF player in the <span className="text-orange-500"><a href=' https://nckuctf.org'>B33F 50μP</a></span> and <span className="text-green-600"><a href=' https://OhYeahSeC.org'>OhYeahSeC</a></span> team.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: isVisible ? 1 : 0, y: isVisible ? 0 : 20 }}
