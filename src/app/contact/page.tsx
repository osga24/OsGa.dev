        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3 sm:gap-4 h-auto">
            ...
            <motion.div
              ...
              className="col-span-2 sm:col-span-3 md:col-span-4 lg:col-span-6 bg-green-500/20 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 border border-green-500/30"
            >
              <div className="flex flex-col sm:flex-row items-center sm:items-start gap-3 sm:gap-4 lg:gap-6">
                {/* 照片區域 */}
                <div className="flex-shrink-0">
                  <div className="w-20 h-20 sm:w-24 sm:h-24 md:w-32 md:h-32 lg:w-40 lg:h-40 bg-gray-600/30 rounded-full border-2 sm:border-3 lg:border-4 border-teal-500/50 flex items-center justify-center overflow-hidden">
                    {/* 照片佔位符 */}
                    <Image
                      src="/avatar.png"
                      alt="Oscar Huang"
                ...
                <div className="flex-1 text-center sm:text-left">
                  <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-green-300 mb-1 sm:mb-2">
                    Yo-Rei Huang
                  </h1>
                  ...
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-300 max-w-2xl leading-relaxed">
                    I&apos;m open to new opportunities, collaborations, or just
            ...
            >
              <div className="flex flex-col sm:flex-row items-start sm:items-center mb-2 sm:mb-4">
                ...
                <div>
                  <h3 className="text-base sm:text-lg md:text-xl font-semibold text-white group-hover:text-red-300">
                    Email
                  </h3>
              ...
              <p className="text-red-300 font-medium text-xs sm:text-sm md:text-base break-all">
            ...
            >
              <div className="flex flex-col sm:flex-row items-start sm:items-center mb-2 sm:mb-4">
                ...
                <div>
                  <h3 className="text-base sm:text-lg md:text-xl font-semibold text-white group-hover:text-gray-300">
                    GitHub
                  </h3>
                  <p className="text-xs sm:text-sm text-gray-400">
                    Code Repository
            ...
            >
              ...
              <h3 className="text-base sm:text-lg md:text-xl font-semibold text-white group-hover:text-blue-300 mb-1 sm:mb-2">
                LinkedIn
              </h3>
              <p className="text-blue-300 font-medium text-xs sm:text-sm md:text-base break-words">
            ...
            >
              ...
              <h3 className="text-base sm:text-lg md:text-xl font-semibold text-white group-hover:text-orange-300 mb-1 sm:mb-2">
                Cake.me
              </h3>
              <p className="text-orange-300 font-medium text-xs sm:text-sm md:text-base">
            ...
            >
              ...
              <h3 className="text-base sm:text-lg md:text-xl font-semibold text-white group-hover:text-indigo-300 mb-1 sm:mb-2">
                Discord
              </h3>
              <p className="text-indigo-300 font-medium text-xs sm:text-sm md:text-base">
                {contactMethods[6].value}
              </p>
            </motion.a>
            ...
            >
              ...
              <p className="text-xs text-pink-300 font-medium text-center leading-tight">
                {contactMethods[4].value}
              </p>
            </motion.a>
            ...
            >
              ...
              <p className="text-xs text-blue-300 font-medium text-center">
                Facebook
              </p>
            </motion.a>
            ...
            >
              <div className="flex items-center mb-3 sm:mb-4">
                ...
                <h3 className="text-base sm:text-lg md:text-xl font-semibold text-green-300">
                  Quick Info
                </h3>
              </div>
